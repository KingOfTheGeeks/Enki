...
public partial class IdentityAudit : ComponentBase
{
    ...
    private async Task FetchAsync()
    {
        ...
        var path = $"admin/audit/identity?{BuildQuery(includeSkipTake: true)}";
    ...
    private string CsvPath => $"admin/audit/identity/csv?{BuildQuery(includeSkipTake: false)}";
    private string CsvDownloadName => $"enki-identity-audit-{DateTimeOffset.Now:yyyy-MM-dd}.csv";
