...
[Route("/admin/audit/master/{EntityType}/{EntityId}")]
[Layout(typeof(AdminLayout))]
[Authorize(Policy = EnkiPolicies.EnkiAdminOnly)]
public partial class MasterAuditEntity : ComponentBase
{
