...
namespace SDI.Enki.Infrastructure.Migrations.Tenant
{
    ...
    [Migration("20260505201238_RenameInjectionToInterceptInModels")]
    partial class RenameInjectionToInterceptInModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SDI.Enki.Core.TenantDb.Models.GradientModel", b =>
                {
                    ...
                    b.Property<int>("InterceptWellId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SDI.Enki.Core.TenantDb.Models.GradientModel", b =>
                {
                    b.HasOne("SDI.Enki.Core.TenantDb.Wells.Well", "InterceptWell")
                        .WithMany()
                        .HasForeignKey("InterceptWellId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
